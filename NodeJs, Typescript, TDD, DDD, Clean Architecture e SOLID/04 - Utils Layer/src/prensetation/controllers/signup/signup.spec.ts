...
describe('SignUp Controller', () => {
  ...
  test('Should call EmailValidator with an correct email', async () => {
    const { sut, emailValidatorStub } = makeSut()
  ...
  test('Should call AddAccount with an correct values', async () => {
    const { sut, addAccountStub } = makeSut()
    const addAccSpy = jest.spyOn(addAccountStub, 'add')
    const httpRequest = {
      body: {
        name: 'test',
        email: 'email@email.com',
    ...
    await sut.handle(httpRequest)
    expect(addAccSpy).toHaveBeenCalledWith({
      name: 'test',
      email: 'email@email.com',
      password: 'password'
    })
